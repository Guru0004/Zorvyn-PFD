...
export function MiniKPIChip({ label, value, icon: Icon, delay = 0 }) {
  return (
    <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-secondary/50 border border-border/50 hover:bg-secondary transition-colors">
...
export function MiniKPIChipSkeleton() {
  return (
    <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-secondary/30 border border-border/30">
